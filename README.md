...
This repository contains open government data ressources of the Sars-Cov-2 vaccination campaign in the Canton of Zurich conducted by the Department of Health of the Canton of Zurich. 
...
This repository is a supplement to the open government data provided via the Federal Office of Public Health (FOPH): <br>
...
Data provided in this repository and by the FOPH may differ due to different collection and publication dates as well as retroactive corrections.
